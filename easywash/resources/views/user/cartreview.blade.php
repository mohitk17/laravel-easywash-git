                  ...
                  <div class="col-md-12">
                      ...
                      <!--INFO ENDS -->
                              ...
                              <dl class="accordion">
                                ...
                                <dd></dd>
                                <dt><a href="">view service and date</a></dt>
                                      ...
                                      @foreach($prices as $price)
                                          ...
                                          <ul class="portfolio-meta m-bot-30 pull-right">
                                              ...
                                              {{$total}}
                                                ...
                                                Sub Total </span>
                                                $ @include('user.total.subtotal')
                                              </li>
                                              <li><span> Delivery Charge	 </span>$ @include('user.total.delivery') </li>

                                              <!-- <li><span> Eco Tax (-2.00)	 </span>  $ 40.00 </li>
                                              <li><span> VAT (20%) </span> $ 498.00 </li> -->
                                              <li><span><strong class="cart-total"> Total </strong></span> <strong class="cart-total">$ @include('user.total.finaltotal')</strong></li>
                                          </ul>
